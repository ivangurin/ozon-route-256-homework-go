...
type ServiceMockMock struct {
	...
	funcInfo          func(ctx context.Context, sku int64) (u1 uint16, err error)
	inspectFuncInfo   func(ctx context.Context, sku int64)
...
func (mmInfo *mServiceMockMockInfo) Expect(ctx context.Context, sku int64) *mServiceMockMockInfo {
	...
	mmInfo.defaultExpectation.params = &ServiceMockMockInfoParams{ctx, sku}
...
func (mmInfo *mServiceMockMockInfo) Inspect(f func(ctx context.Context, sku int64)) *mServiceMockMockInfo {
...
func (mmInfo *mServiceMockMockInfo) Set(f func(ctx context.Context, sku int64) (u1 uint16, err error)) *ServiceMockMock {
	if mmInfo.defaultExpectation != nil {
...
// Then helper
func (mmInfo *mServiceMockMockInfo) When(ctx context.Context, sku int64) *ServiceMockMockInfoExpectation {
	if mmInfo.mock.funcInfo != nil {
		mmInfo.mock.t.Fatalf("ServiceMockMock.Info mock is already set by Set")
	}
	...
	expectation := &ServiceMockMockInfoExpectation{
		mock:   mmInfo.mock,
		params: &ServiceMockMockInfoParams{ctx, sku},
	}
...
func (mmInfo *ServiceMockMock) Info(ctx context.Context, sku int64) (u1 uint16, err error) {
	...
	if mmInfo.inspectFuncInfo != nil {
		mmInfo.inspectFuncInfo(ctx, sku)
	}

	mm_params := &ServiceMockMockInfoParams{ctx, sku}
	...
	if mmInfo.InfoMock.defaultExpectation != nil {
		...
		mm_got := ServiceMockMockInfoParams{ctx, sku}
	...
	if mmInfo.funcInfo != nil {
		return mmInfo.funcInfo(ctx, sku)
	}
	mmInfo.t.Fatalf("Unexpected call to ServiceMockMock.Info. %v %v", ctx, sku)
	return
}

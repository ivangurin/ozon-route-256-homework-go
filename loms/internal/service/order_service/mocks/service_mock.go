...
type ServiceMockMock struct {
	...
	funcCancel          func(orderID int64) (err error)
	inspectFuncCancel   func(orderID int64)
	afterCancelCounter  uint64
	beforeCancelCounter uint64
	CancelMock          mServiceMockMockCancel

	funcCreate          func(user int64, items model.OrderItems) (i1 int64, err error)
	inspectFuncCreate   func(user int64, items model.OrderItems)
	afterCreateCounter  uint64
	beforeCreateCounter uint64
	CreateMock          mServiceMockMockCreate

	funcInfo          func(orderID int64) (op1 *model.Order, err error)
	inspectFuncInfo   func(orderID int64)
	afterInfoCounter  uint64
	beforeInfoCounter uint64
	InfoMock          mServiceMockMockInfo

	funcPay          func(orderID int64) (err error)
	inspectFuncPay   func(orderID int64)
...
func (mmCancel *mServiceMockMockCancel) Expect(orderID int64) *mServiceMockMockCancel {
	...
	mmCancel.defaultExpectation.params = &ServiceMockMockCancelParams{orderID}
...
func (mmCancel *mServiceMockMockCancel) Inspect(f func(orderID int64)) *mServiceMockMockCancel {
...
func (mmCancel *mServiceMockMockCancel) Set(f func(orderID int64) (err error)) *ServiceMockMock {
	if mmCancel.defaultExpectation != nil {
...
// Then helper
func (mmCancel *mServiceMockMockCancel) When(orderID int64) *ServiceMockMockCancelExpectation {
	if mmCancel.mock.funcCancel != nil {
		mmCancel.mock.t.Fatalf("ServiceMockMock.Cancel mock is already set by Set")
	}
	...
	expectation := &ServiceMockMockCancelExpectation{
		mock:   mmCancel.mock,
		params: &ServiceMockMockCancelParams{orderID},
	}
...
func (mmCancel *ServiceMockMock) Cancel(orderID int64) (err error) {
	...
	if mmCancel.inspectFuncCancel != nil {
		mmCancel.inspectFuncCancel(orderID)
	}

	mm_params := &ServiceMockMockCancelParams{orderID}
	...
	if mmCancel.CancelMock.defaultExpectation != nil {
		...
		mm_got := ServiceMockMockCancelParams{orderID}
	...
	if mmCancel.funcCancel != nil {
		return mmCancel.funcCancel(orderID)
	}
	mmCancel.t.Fatalf("Unexpected call to ServiceMockMock.Cancel. %v", orderID)
	return
}
...
func (mmCreate *mServiceMockMockCreate) Expect(user int64, items model.OrderItems) *mServiceMockMockCreate {
	...
	mmCreate.defaultExpectation.params = &ServiceMockMockCreateParams{user, items}
...
func (mmCreate *mServiceMockMockCreate) Inspect(f func(user int64, items model.OrderItems)) *mServiceMockMockCreate {
...
func (mmCreate *mServiceMockMockCreate) Set(f func(user int64, items model.OrderItems) (i1 int64, err error)) *ServiceMockMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mServiceMockMockCreate) When(user int64, items model.OrderItems) *ServiceMockMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ServiceMockMock.Create mock is already set by Set")
	}
	...
	expectation := &ServiceMockMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &ServiceMockMockCreateParams{user, items},
	}
...
func (mmCreate *ServiceMockMock) Create(user int64, items model.OrderItems) (i1 int64, err error) {
	...
	mm_params := &ServiceMockMockCreateParams{user, items}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ServiceMockMockCreateParams{user, items}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmCreate.t.Fatalf("Unexpected call to ServiceMockMock.Create. %v %v", user, items)
	return
}
...
func (mmInfo *mServiceMockMockInfo) Expect(orderID int64) *mServiceMockMockInfo {
	...
	mmInfo.defaultExpectation.params = &ServiceMockMockInfoParams{orderID}
...
func (mmInfo *mServiceMockMockInfo) Inspect(f func(orderID int64)) *mServiceMockMockInfo {
...
func (mmInfo *mServiceMockMockInfo) Set(f func(orderID int64) (op1 *model.Order, err error)) *ServiceMockMock {
	if mmInfo.defaultExpectation != nil {
...
// Then helper
func (mmInfo *mServiceMockMockInfo) When(orderID int64) *ServiceMockMockInfoExpectation {
	if mmInfo.mock.funcInfo != nil {
		mmInfo.mock.t.Fatalf("ServiceMockMock.Info mock is already set by Set")
	}
	...
	expectation := &ServiceMockMockInfoExpectation{
		mock:   mmInfo.mock,
		params: &ServiceMockMockInfoParams{orderID},
	}
...
func (mmInfo *ServiceMockMock) Info(orderID int64) (op1 *model.Order, err error) {
	...
	if mmInfo.inspectFuncInfo != nil {
		mmInfo.inspectFuncInfo(orderID)
	}

	mm_params := &ServiceMockMockInfoParams{orderID}
	...
	if mmInfo.InfoMock.defaultExpectation != nil {
		...
		mm_got := ServiceMockMockInfoParams{orderID}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmInfo.funcInfo != nil {
		return mmInfo.funcInfo(orderID)
	}
	mmInfo.t.Fatalf("Unexpected call to ServiceMockMock.Info. %v", orderID)
	return
}
...
func (mmPay *mServiceMockMockPay) Expect(orderID int64) *mServiceMockMockPay {
	...
	mmPay.defaultExpectation.params = &ServiceMockMockPayParams{orderID}
...
func (mmPay *mServiceMockMockPay) Inspect(f func(orderID int64)) *mServiceMockMockPay {
...
func (mmPay *mServiceMockMockPay) Set(f func(orderID int64) (err error)) *ServiceMockMock {
	if mmPay.defaultExpectation != nil {
...
// Then helper
func (mmPay *mServiceMockMockPay) When(orderID int64) *ServiceMockMockPayExpectation {
	if mmPay.mock.funcPay != nil {
		mmPay.mock.t.Fatalf("ServiceMockMock.Pay mock is already set by Set")
	}
	...
	expectation := &ServiceMockMockPayExpectation{
		mock:   mmPay.mock,
		params: &ServiceMockMockPayParams{orderID},
	}
...
func (mmPay *ServiceMockMock) Pay(orderID int64) (err error) {
	mm_atomic.AddUint64(&mmPay.beforePayCounter, 1)
	defer mm_atomic.AddUint64(&mmPay.afterPayCounter, 1)

	if mmPay.inspectFuncPay != nil {
		mmPay.inspectFuncPay(orderID)
	}

	mm_params := &ServiceMockMockPayParams{orderID}
	...
	if mmPay.PayMock.defaultExpectation != nil {
		...
		mm_got := ServiceMockMockPayParams{orderID}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmPay.funcPay != nil {
		return mmPay.funcPay(orderID)
	}
	mmPay.t.Fatalf("Unexpected call to ServiceMockMock.Pay. %v", orderID)
	return
}

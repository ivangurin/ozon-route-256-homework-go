...
type RepositoryMockMock struct {
	...
	funcCancelReserve          func(items mm_stockstorage.ReserveItems) (err error)
	inspectFuncCancelReserve   func(items mm_stockstorage.ReserveItems)
	afterCancelReserveCounter  uint64
	beforeCancelReserveCounter uint64
	CancelReserveMock          mRepositoryMockMockCancelReserve

	funcGetBySku          func(sku int64) (u1 uint16, err error)
	inspectFuncGetBySku   func(sku int64)
	afterGetBySkuCounter  uint64
	beforeGetBySkuCounter uint64
	GetBySkuMock          mRepositoryMockMockGetBySku

	funcRemoveReserve          func(items mm_stockstorage.ReserveItems) (err error)
	inspectFuncRemoveReserve   func(items mm_stockstorage.ReserveItems)
	afterRemoveReserveCounter  uint64
	beforeRemoveReserveCounter uint64
	RemoveReserveMock          mRepositoryMockMockRemoveReserve

	funcReserve          func(items mm_stockstorage.ReserveItems) (err error)
	inspectFuncReserve   func(items mm_stockstorage.ReserveItems)
...
func (mmCancelReserve *mRepositoryMockMockCancelReserve) Expect(items mm_stockstorage.ReserveItems) *mRepositoryMockMockCancelReserve {
	...
	mmCancelReserve.defaultExpectation.params = &RepositoryMockMockCancelReserveParams{items}
...
func (mmCancelReserve *mRepositoryMockMockCancelReserve) Inspect(f func(items mm_stockstorage.ReserveItems)) *mRepositoryMockMockCancelReserve {
...
func (mmCancelReserve *mRepositoryMockMockCancelReserve) Set(f func(items mm_stockstorage.ReserveItems) (err error)) *RepositoryMockMock {
	if mmCancelReserve.defaultExpectation != nil {
...
// Then helper
func (mmCancelReserve *mRepositoryMockMockCancelReserve) When(items mm_stockstorage.ReserveItems) *RepositoryMockMockCancelReserveExpectation {
	if mmCancelReserve.mock.funcCancelReserve != nil {
		mmCancelReserve.mock.t.Fatalf("RepositoryMockMock.CancelReserve mock is already set by Set")
	}
	...
	expectation := &RepositoryMockMockCancelReserveExpectation{
		...
		params: &RepositoryMockMockCancelReserveParams{items},
	}
...
func (mmCancelReserve *RepositoryMockMock) CancelReserve(items mm_stockstorage.ReserveItems) (err error) {
	...
	mm_params := &RepositoryMockMockCancelReserveParams{items}
	...
	if mmCancelReserve.CancelReserveMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockMockCancelReserveParams{items}
	...
	mmCancelReserve.t.Fatalf("Unexpected call to RepositoryMockMock.CancelReserve. %v", items)
	return
}
...
func (mmGetBySku *mRepositoryMockMockGetBySku) Expect(sku int64) *mRepositoryMockMockGetBySku {
	...
	mmGetBySku.defaultExpectation.params = &RepositoryMockMockGetBySkuParams{sku}
...
func (mmGetBySku *mRepositoryMockMockGetBySku) Inspect(f func(sku int64)) *mRepositoryMockMockGetBySku {
...
func (mmGetBySku *mRepositoryMockMockGetBySku) Set(f func(sku int64) (u1 uint16, err error)) *RepositoryMockMock {
	if mmGetBySku.defaultExpectation != nil {
...
// Then helper
func (mmGetBySku *mRepositoryMockMockGetBySku) When(sku int64) *RepositoryMockMockGetBySkuExpectation {
	if mmGetBySku.mock.funcGetBySku != nil {
		mmGetBySku.mock.t.Fatalf("RepositoryMockMock.GetBySku mock is already set by Set")
	}
	...
	expectation := &RepositoryMockMockGetBySkuExpectation{
		...
		params: &RepositoryMockMockGetBySkuParams{sku},
	}
...
func (mmGetBySku *RepositoryMockMock) GetBySku(sku int64) (u1 uint16, err error) {
	...
	if mmGetBySku.inspectFuncGetBySku != nil {
		mmGetBySku.inspectFuncGetBySku(sku)
	}

	mm_params := &RepositoryMockMockGetBySkuParams{sku}
	...
	if mmGetBySku.GetBySkuMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockMockGetBySkuParams{sku}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetBySku.funcGetBySku != nil {
		return mmGetBySku.funcGetBySku(sku)
	}
	mmGetBySku.t.Fatalf("Unexpected call to RepositoryMockMock.GetBySku. %v", sku)
	return
}
...
func (mmRemoveReserve *mRepositoryMockMockRemoveReserve) Expect(items mm_stockstorage.ReserveItems) *mRepositoryMockMockRemoveReserve {
	...
	mmRemoveReserve.defaultExpectation.params = &RepositoryMockMockRemoveReserveParams{items}
...
func (mmRemoveReserve *mRepositoryMockMockRemoveReserve) Inspect(f func(items mm_stockstorage.ReserveItems)) *mRepositoryMockMockRemoveReserve {
...
func (mmRemoveReserve *mRepositoryMockMockRemoveReserve) Set(f func(items mm_stockstorage.ReserveItems) (err error)) *RepositoryMockMock {
	if mmRemoveReserve.defaultExpectation != nil {
...
// Then helper
func (mmRemoveReserve *mRepositoryMockMockRemoveReserve) When(items mm_stockstorage.ReserveItems) *RepositoryMockMockRemoveReserveExpectation {
	if mmRemoveReserve.mock.funcRemoveReserve != nil {
		mmRemoveReserve.mock.t.Fatalf("RepositoryMockMock.RemoveReserve mock is already set by Set")
	}
	...
	expectation := &RepositoryMockMockRemoveReserveExpectation{
		...
		params: &RepositoryMockMockRemoveReserveParams{items},
	}
...
func (mmRemoveReserve *RepositoryMockMock) RemoveReserve(items mm_stockstorage.ReserveItems) (err error) {
	...
	if mmRemoveReserve.inspectFuncRemoveReserve != nil {
		mmRemoveReserve.inspectFuncRemoveReserve(items)
	}

	mm_params := &RepositoryMockMockRemoveReserveParams{items}
	...
	if mmRemoveReserve.RemoveReserveMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockMockRemoveReserveParams{items}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmRemoveReserve.funcRemoveReserve != nil {
		return mmRemoveReserve.funcRemoveReserve(items)
	}
	mmRemoveReserve.t.Fatalf("Unexpected call to RepositoryMockMock.RemoveReserve. %v", items)
	return
}
...
func (mmReserve *mRepositoryMockMockReserve) Expect(items mm_stockstorage.ReserveItems) *mRepositoryMockMockReserve {
	...
	mmReserve.defaultExpectation.params = &RepositoryMockMockReserveParams{items}
...
func (mmReserve *mRepositoryMockMockReserve) Inspect(f func(items mm_stockstorage.ReserveItems)) *mRepositoryMockMockReserve {
...
func (mmReserve *mRepositoryMockMockReserve) Set(f func(items mm_stockstorage.ReserveItems) (err error)) *RepositoryMockMock {
	if mmReserve.defaultExpectation != nil {
...
// Then helper
func (mmReserve *mRepositoryMockMockReserve) When(items mm_stockstorage.ReserveItems) *RepositoryMockMockReserveExpectation {
	if mmReserve.mock.funcReserve != nil {
		mmReserve.mock.t.Fatalf("RepositoryMockMock.Reserve mock is already set by Set")
	}
	...
	expectation := &RepositoryMockMockReserveExpectation{
		mock:   mmReserve.mock,
		params: &RepositoryMockMockReserveParams{items},
	}
...
func (mmReserve *RepositoryMockMock) Reserve(items mm_stockstorage.ReserveItems) (err error) {
	...
	if mmReserve.inspectFuncReserve != nil {
		mmReserve.inspectFuncReserve(items)
	}

	mm_params := &RepositoryMockMockReserveParams{items}
	...
	if mmReserve.ReserveMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockMockReserveParams{items}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmReserve.funcReserve != nil {
		return mmReserve.funcReserve(items)
	}
	mmReserve.t.Fatalf("Unexpected call to RepositoryMockMock.Reserve. %v", items)
	return
}

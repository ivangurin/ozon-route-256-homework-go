...
type RepositoryMockMock struct {
	...
	funcCreate          func(ctx context.Context, user int64, items []*mm_orderstorage.OrderItem) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, user int64, items []*mm_orderstorage.OrderItem)
	afterCreateCounter  uint64
	beforeCreateCounter uint64
	CreateMock          mRepositoryMockMockCreate

	funcGetByID          func(ctx context.Context, orderID int64) (op1 *mm_orderstorage.Order, err error)
...
func (mmCreate *mRepositoryMockMockCreate) Expect(ctx context.Context, user int64, items []*mm_orderstorage.OrderItem) *mRepositoryMockMockCreate {
	...
	mmCreate.defaultExpectation.params = &RepositoryMockMockCreateParams{ctx, user, items}
...
func (mmCreate *mRepositoryMockMockCreate) Inspect(f func(ctx context.Context, user int64, items []*mm_orderstorage.OrderItem)) *mRepositoryMockMockCreate {
...
func (mmCreate *mRepositoryMockMockCreate) Set(f func(ctx context.Context, user int64, items []*mm_orderstorage.OrderItem) (i1 int64, err error)) *RepositoryMockMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mRepositoryMockMockCreate) When(ctx context.Context, user int64, items []*mm_orderstorage.OrderItem) *RepositoryMockMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("RepositoryMockMock.Create mock is already set by Set")
	}
	...
	expectation := &RepositoryMockMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &RepositoryMockMockCreateParams{ctx, user, items},
	}
...
func (mmCreate *RepositoryMockMock) Create(ctx context.Context, user int64, items []*mm_orderstorage.OrderItem) (i1 int64, err error) {
	...
	mm_params := &RepositoryMockMockCreateParams{ctx, user, items}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockMockCreateParams{ctx, user, items}
	...
	mmCreate.t.Fatalf("Unexpected call to RepositoryMockMock.Create. %v %v %v", ctx, user, items)
	return
}
...
func (mmGetByID *mRepositoryMockMockGetByID) Expect(ctx context.Context, orderID int64) *mRepositoryMockMockGetByID {
	...
	mmGetByID.defaultExpectation.params = &RepositoryMockMockGetByIDParams{ctx, orderID}
...
func (mmGetByID *mRepositoryMockMockGetByID) Inspect(f func(ctx context.Context, orderID int64)) *mRepositoryMockMockGetByID {
...
func (mmGetByID *mRepositoryMockMockGetByID) Set(f func(ctx context.Context, orderID int64) (op1 *mm_orderstorage.Order, err error)) *RepositoryMockMock {
	if mmGetByID.defaultExpectation != nil {
...
// Then helper
func (mmGetByID *mRepositoryMockMockGetByID) When(ctx context.Context, orderID int64) *RepositoryMockMockGetByIDExpectation {
	if mmGetByID.mock.funcGetByID != nil {
		mmGetByID.mock.t.Fatalf("RepositoryMockMock.GetByID mock is already set by Set")
	}
	...
	expectation := &RepositoryMockMockGetByIDExpectation{
		mock:   mmGetByID.mock,
		params: &RepositoryMockMockGetByIDParams{ctx, orderID},
	}
...
func (mmGetByID *RepositoryMockMock) GetByID(ctx context.Context, orderID int64) (op1 *mm_orderstorage.Order, err error) {
	...
	mm_params := &RepositoryMockMockGetByIDParams{ctx, orderID}
	...
	if mmGetByID.GetByIDMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockMockGetByIDParams{ctx, orderID}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGetByID.t.Fatalf("Unexpected call to RepositoryMockMock.GetByID. %v %v", ctx, orderID)
	return
}
...
func (mmSetStatus *mRepositoryMockMockSetStatus) Expect(ctx context.Context, orderID int64, status string) *mRepositoryMockMockSetStatus {
	...
	mmSetStatus.defaultExpectation.params = &RepositoryMockMockSetStatusParams{ctx, orderID, status}
...
func (mmSetStatus *mRepositoryMockMockSetStatus) Inspect(f func(ctx context.Context, orderID int64, status string)) *mRepositoryMockMockSetStatus {
...
func (mmSetStatus *mRepositoryMockMockSetStatus) Set(f func(ctx context.Context, orderID int64, status string) (err error)) *RepositoryMockMock {
	if mmSetStatus.defaultExpectation != nil {
...
// Then helper
func (mmSetStatus *mRepositoryMockMockSetStatus) When(ctx context.Context, orderID int64, status string) *RepositoryMockMockSetStatusExpectation {
	if mmSetStatus.mock.funcSetStatus != nil {
		mmSetStatus.mock.t.Fatalf("RepositoryMockMock.SetStatus mock is already set by Set")
	}
	...
	expectation := &RepositoryMockMockSetStatusExpectation{
		...
		params: &RepositoryMockMockSetStatusParams{ctx, orderID, status},
	}
...
func (mmSetStatus *RepositoryMockMock) SetStatus(ctx context.Context, orderID int64, status string) (err error) {
	...
	mm_params := &RepositoryMockMockSetStatusParams{ctx, orderID, status}
	...
	if mmSetStatus.SetStatusMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockMockSetStatusParams{ctx, orderID, status}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmSetStatus.t.Fatalf("Unexpected call to RepositoryMockMock.SetStatus. %v %v %v", ctx, orderID, status)
	return
}
